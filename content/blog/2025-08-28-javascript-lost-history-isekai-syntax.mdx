...
date: 2025-09-01T12:20:16.777Z
description: 지금은 표준에서 사라졌지만 한때는 존재했던, 혹은 다른 세상에서 쓰였던 JavaScript의 신기한 문법들을 탐험합니다. JScript부터 E4X, JScript.NET까지, 이 고대 기술들이 현대 개발에 주는 교훈을 찾아보세요.
meta:
  keywords:
    - JavaScript
    - ECMAScript
...
# 자바스크립트의 잃어버린 역사, 당신이 몰랐던 '이세계'의 문법들
