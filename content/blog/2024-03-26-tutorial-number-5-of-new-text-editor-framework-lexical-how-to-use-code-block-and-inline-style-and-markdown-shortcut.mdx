...
date: 2024-03-26T13:07:55.004Z
description: Draft.js를 대체하는 Lexical 강좌 5편. 코드 블럭 구현과 인라인 스타일, 마크다운과 같은 단축기 구현하기
meta:
  keywords:
    - lexical
    - code block
...
# Lexical 강좌 5편. 코드 블럭 구현과 인라인 스타일, 마크다운과 같은 단축기 구현하기
