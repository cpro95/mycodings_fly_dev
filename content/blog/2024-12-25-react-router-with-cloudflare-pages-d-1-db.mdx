...
description: React Router V7를 Cloudflare Pages에 D1 DB를 이용해서 배포할 수 있게 개조하기
meta:
  keywords:
    - react
    - react router v7
...
# React Router V7과 Cloudflare Pages 그리고 D1 Database 사용
...
```sh
➜ pnpx wrangler d1 execute mydb --local --
file=./db/schema.sql
