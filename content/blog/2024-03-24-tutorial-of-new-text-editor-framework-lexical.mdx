...
Meta에서 더 이상 Draft.js를 개발하지 않고 있고 새로운 텍스트 에디터 프레임워크를 내 놓았는데요.
...
RichTextPlugin은 이름에서 알 수 있듯이 리치 텍스트 에디터 기능을 설정해주는 플러그인입니다.
...
위 그림을 보시면 CSS가 적용되어 플레이스홀더가 정확히 에디터위에 겹쳐 보이고 있습니다.
