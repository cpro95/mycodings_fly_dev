...
date: 2025-09-07T04:47:25.534Z
description: Next.js 없이 React 서버 컴포넌트를 사용하려는 한 해외 개발자의 도전을 소개합니다. Krasimir Tsonev가 만든 Forket이라는 도구가 어떻게 이 문제를 해결하는지 자세히 살펴보시죠.
meta:
  keywords:
    - React
    - 서버 컴포넌트
...
# 프레임워크 없는 React 서버 컴포넌트 라이브러리 Forket을 소개합니다
