...
# astrojs 강좌 3편. 웹 컴포넌트로 직접 아일랜드 아키텍처 구현해 보기
...
document.readyState 항목을 이용할 건데요.

이게 complete이면 조건이 만족하는 상태인 거죠.

그리고 window.requestIdleCallback() 메서드가 있는데요.
