...
date: 2023-03-24T13:49:31.558Z
description: Next.js로 브이월드(VWorld) 공간정보 오픈 플랫폼 지도 오픈 API 사용하기
meta:
  keywords:
    - next.js
    - vworld
...
# Next.js로 브이월드(VWorld) 공간정보 오픈 플랫폼 지도 오픈 API 사용하기
...
만약 제 웹이 대박을 친다고 했을 때 사용료를 어마어마하게 내야 한다면 좀 부담이 되겠죠.
...
## VWorld가 제공하는 SDK로 지도 만들어 보기

먼저, VWorld가 제공하는 자바스크립트 SDK가 있습니다.

![](https://blogger.googleusercontent.com/img/a/AVvXsEi1yGiWSPei-Yki9sTHMrFR43ggwY81yTnpQsWr3FDYTeIGwuT3oSmrvPE8H4mWwAS1cXNAoqbmab9TU0rKashSDTZggor24XGT2tEOg7Ia1_wz1tDAc5knnPD4jUZyVhSNnIdiOSDOuNxPA3zOHTwEieo0lfVJoI9jg1y3wnGBcdkBQwSRjuRFjWOw)
...
<script
  ...
  src='http://map.vworld.kr/js/vworldMapInit.js.do?version=2.0&apiKey=[인증키]'
></script>
```

이제 테스트를 위한 Nest.js 템플릿을 만들까요?
...
VWorld나 모든 지도 데이터는 OpenLayers를 이용하고 있는데요.
...
이제 Map 객체를 만들었고 이 Map 객체를 브라우저에 나타내어 보는 것도 했는데요.

이제 지도 위에 마커를 넣는걸 해보겠습니다.
