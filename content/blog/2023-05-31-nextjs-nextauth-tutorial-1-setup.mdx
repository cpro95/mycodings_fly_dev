...
date: 2023-05-31T09:29:00.910Z
description: NextAuth 사용법 1편 - Setup, Credentials
meta:
  keywords:
    - next.js
    - nextauth
...
주소를 'http://localhost:3000/api/auth/signin'으로 이동해 보십시오.
...
`http://localhost:3000/api/auth/callback/credentials` 같은 이상한 주소로 이동하게 되는데요.
