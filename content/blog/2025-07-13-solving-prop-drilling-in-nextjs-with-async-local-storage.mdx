...
date: 2025-07-12T10:32:04.000Z
description: 서버 사이드 함수에서 반복되는 매개변수 전달, 즉 'prop drilling'의 고통을 Node.js의 Async Local Storage로 해결하는 방법을 알아봅니다. React Context처럼 동작하는 이 강력한 기능을 마스터해 보세요.
meta:
  keywords:
    - Async Local Storage
    - Next.js
...
published: true
---
# Next.js 라우트 핸들러의 Prop Drilling, 'Node.js의 React Context'로 해결하기
