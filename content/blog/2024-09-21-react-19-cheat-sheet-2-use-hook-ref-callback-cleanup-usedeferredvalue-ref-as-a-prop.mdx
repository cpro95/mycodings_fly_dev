...
date: 2024-09-21T04:03:58.167Z
description: React 19 치트 시트 2편입니다. 메타데이터 서포트와 use 훅과 Ref 콜백 클린업, useDeferredValue 초기 값, 하이드레이션 오류 디프, ref as a Prop에 대해 공부해봅시다.
meta:
  keywords:
    - react
...
# React 19 완벽 가이드 2편 - Document Metadata Support, use Hook, Ref Callback Clenup, useDeferredValue Initial Value, 하이드레이션 오류 디프, ref as a Prop 등
