...
- [**1. 프로젝트 생성 및 환경 설정**](#1-프로젝트-생성-및-환경-설정)
  - [**1-1. Vite 프로젝트 생성**](#1-1-vite-프로젝트-생성)
  - [**1-2. Tailwind CSS v4 및 라이브러리 설치**](#1-2-tailwind-css-v4-및-라이브러리-설치)
  - [**1-3. 불필요한 리액트 패키지 정리**](#1-3-불필요한-리액트-패키지-정리)
- [**2. 설정 파일 수정하기**](#2-설정-파일-수정하기)
  - [**2-1. vite.config.ts (핵심)**](#2-1-viteconfigts-핵심)
  - [**2-2. tsconfig.app.json**](#2-2-tsconfigappjson)
  - [**2-3. eslint.config.js**](#2-3-eslintconfigjs)
  - [**2-4. src/index.css**](#2-4-srcindexcss)
- [**3. 프로젝트 구조 및 타입 정의**](#3-프로젝트-구조-및-타입-정의)
- [**4. 컴포넌트 구현**](#4-컴포넌트-구현)
  - [**(1) TaskInput: 입력창 구현**](#1-taskinput-입력창-구현)
  - [**(2) TaskList: 리스트 및 삭제 기능 추가**](#2-tasklist-리스트-및-삭제-기능-추가)
  - [**(3) TaskFilter: 필터링 UI**](#3-taskfilter-필터링-ui)
- [**5. App.tsx에 모두 모아넣기**](#5-apptsx에-모두-모아넣기)
- [**6. Remix 3 진입점 설정**](#6-remix-3-진입점-설정)
- [**숫자로 증명하는 압도적인 가벼움**](#숫자로-증명하는-압도적인-가벼움)

---

### **익숙한 맛(React)과 새로운 맛(Remix)의 조화**
