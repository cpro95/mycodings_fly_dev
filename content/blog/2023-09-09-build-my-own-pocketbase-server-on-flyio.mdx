...
date: 2023-09-09T02:15:59.730Z
description: Fly.io에 직접 Dockerfile로 pocketbase 서버 구축
meta:
  keywords:
    - pocketbase
    - fly.io
...
# PocketBase 활용법 1탄. 나만의 pocketbase 서버 만들기 in Fly.io
...
## DB 강제로 초기화하기 또는 관리자 비밀번호를 잊어버린 경우
