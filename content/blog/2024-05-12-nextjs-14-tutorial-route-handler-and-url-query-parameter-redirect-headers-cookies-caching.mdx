...
date: 2024-05-12T10:53:04.153Z
description: 라우트 핸들러의 고급 동작 알아보기, redirect, 쿼리 파라미터, Headers, Cookies, Caching
meta:
  keywords:
    - next.js
    - route handler
...
# Next.js 14 강좌 8편, 라우트 핸들러에서 URL 쿼리 파라미터와 redirect, Headers, Cookies 그리고 캐싱 방식 알아보기
