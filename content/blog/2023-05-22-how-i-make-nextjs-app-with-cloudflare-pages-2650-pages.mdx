...
title: Next.js로 2,650페이지의 정적 사이트 만든 경험담 공유 (Cloudflare Pages)
date: 2023-05-22T07:55:11.333Z
description: Next.js로 2,650페이지의 정적 사이트 만든 경험담 공유 (Cloudflare Pages)
meta:
  keywords:
    - next.js
    - cloudflare
...
# Next.js로 2,650페이지의 정적 사이트 만든 경험담 공유 (Cloudflare Pages)

안녕하세요?

제가 몇 달 전에 완성한 취비 프로젝트가 있었는데요.
...
그리고 오라클 클라우드의 무료 서버에서는 Crontab을 이용해서 매주 토요일 저녁 9시 30분에 이번 주차 당첨 번호를 파이선으로 끓어서 Strapi에 저장하고, 그다음 으로 Cloudflare에서 재 빌드하면 됩니다.
...
마지막으로 Cloudflare Pages를 다시 빌드 해야 하는데요.
