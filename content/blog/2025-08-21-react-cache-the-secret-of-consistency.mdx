...
date: 2025-08-23T06:22:43.632Z
description: React의 cache 함수는 단순한 성능 최적화 도구가 아닙니다. React 서버 컴포넌트(RSC) 환경에서 데이터 일관성을 보장하는 핵심 API로서 cache의 진짜 역할을 깊이 있게 파헤칩니다.
meta:
  keywords:
    - React
    - React Cache
...
# React Cache 그냥 쓰셨나요? (숨겨진 일관성의 비밀)
