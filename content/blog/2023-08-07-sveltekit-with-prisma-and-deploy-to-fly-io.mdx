...
description: Dockerfile 세팅해서 자동으로 Prisma 설치 및 초기 데이터 세팅까지
meta:
  keywords:
    - prisma
    - sveltekit
...
# SvelteKit 실전 예제 4편 - Prisma 설치 후 백 엔드 DB 세팅 및 클라우드에 자동 배포하기
...
한참 기다리고 나서 실제 주소로 접속해 봅시다.

그러면 아래와 같이 API 엔드 포인트까지 정상 작동한다고 나올 겁니다.

![](https://blogger.googleusercontent.com/img/a/AVvXsEhj3kEvjtnVCnAqXnQQvUwVBUMjwatf_t7D1hVfK1DrT7IvJsRZsiw9CZHDycWNRFJw-NH4RSnUIQa4POQRKvtH6pVOOMMHpueLK81A3mvWIBqJVQ3pNdgaVCfDG5GCftlud0JbW1dWc9AhOlu1faEE88kB3SJr6nAGP_LUBWh1uWMFkWWGBx9tJPEV4q0)

![](https://blogger.googleusercontent.com/img/a/AVvXsEjg7OIbAe9Erqm7AVSa-kZsZVEung4LvlqgPp0V8gDzFOtm4Hir43c8Boc3tFxxVfGS4m_PuBHlLOAOaG2AvJX_c0XNZO7tBPjX4lE-sq6ap9ecAzZJhP-vJa9BCsIXe8CaRhAgJ__ghzVGi_AQOlNkIO04cFL_jXxzq2bnI6AtWTPsJe6XO_32c0_j3Xo)
