...
date: 2025-08-19T14:13:25.909Z
description: 테스트 코드가 어느새 짐이 되어버렸나요? 개발 속도를 높여주고 프로덕션 배포에 자신감을 심어주는 '가치 있는 테스트'의 4가지 속성과 구체적인 작성법을 Egil Hansen의 강연을 통해 깊이 있게 살펴봅니다.
meta:
  keywords:
    - 테스트
    - TDD
